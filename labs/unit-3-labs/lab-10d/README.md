...
1. __Duration__ (10 minutes): Execute the `runme-primal.jl` script with the bounds $10.0\leq\dot{n}_{A1,1}\geq{10.0}$ and $0.0\leq\dot{n}_{B,1}\geq{0.0}$  (see the `bounds_array` on `L39`). What is the meaning of these constraints, and the solution obtained?
