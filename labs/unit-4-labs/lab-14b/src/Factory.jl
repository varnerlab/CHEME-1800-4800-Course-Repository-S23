...
"""
    build(modeltype::Type{MyCoinFlipGameModel}, data::NamedTuple) -> MyCoinFlipGameModel
"""
function build(modeltype::Type{MyCoinFlipGameModel}, data::NamedTuple)::MyCoinFlipGameModel

    # initialize -
    model = MyCoinFlipGameModel(); # this model is empty
